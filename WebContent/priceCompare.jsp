					...
					<div class="center">
						...
						<!-- Section -->
								<section>
									<div class="posts">
										<article>
											<a href="https://www.momotee.co.kr" class="image"><img src="./images/momotee.png" alt="모모티 바로가기"/></a>
											<p>후드 평균가 : 20,232 원<br/> 야구 잠바 평균가 : 31,043 원 <br/> 패딩 평균가 : 49,856 원   </p>
											
										</article>
										<article>
											<a href="https://www.townus.co.kr" class="image"><img src="./images/town.png" alt="타운어스 바로가기" /></a>
											<p>후드 평균가 : 25,209 원<br/> 야구 잠바 평균가 : 41,147 원 <br/> 패딩 평균가 : 52,806 원   </p>
										
										</article>
										<article>
											<a href="http://moggogio.cafe24.com" class="image"><img src="./images/mocco.png" alt="모꼬지오 바로가기" /></a>
											<p>후드 평균가 : 13,200 원<br/> 야구 잠바 평균가 : 43,152 원 <br/> 패딩 평균가 : 51,786 원   </p>
										
										</article>
										<article>
											<a href="http://buzzfactory.co.kr/" class="image"><img src="./images/buz.png" alt="버즈팩토리 바로가기" /></a>
											<p>후드 평균가 : 12,900 원<br/> 야구 잠바 평균가 : 34,900 원 <br/> 패딩 평균가 : 49,900 원   </p>
